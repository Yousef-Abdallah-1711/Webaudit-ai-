 ...
 * produced by ../src/runner.ts against https://trimora.sy/ — no mock
  ...
  return (
    <div>
      <PageHead
        ...
        title="trimora.sy"
        meta={null}
        actions={<><a href={DL.report} download="trimora-audit-report.md" style={{ textDecoration: 'none' }}><Button variant="secondary" size="sm">Full report.md</Button></a><a href={DL.audit} download="trimora-audit.json" style={{ textDecoration: 'none' }}><Button size="sm">Raw JSON</Button></a></>}
      />
  ...
  return (
    <div>
      <PageHead
        ...
        actions={
          <>
            <a href={'data:text/markdown;charset=utf-8,' + encodeURIComponent(findingsMd)} download="trimora-findings-log.md" style={{ textDecoration: 'none' }}>
              <Button variant="secondary" size="sm">Export findings</Button>
            </a>
            <a href={DL.runbook} download="trimora-PENTEST-RUNBOOK.md" style={{ textDecoration: 'none' }}>
