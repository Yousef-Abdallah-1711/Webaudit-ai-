...
async function main(): Promise<void> {
  ...
  try {
    ...
    md.push(`It covers **${rb.summary.phases} phases / ${rb.summary.testCases} test cases**:`);
    md.push('');
  ...
  md.push('---');
  md.push('');
  md.push(`_Generated by \`showcase-trimora\`. Raw data: \`data/audit.json\`. Dashboard: \`pnpm --filter showcase-trimora serve\`._`);
  md.push('');
